...
import { Pai, Div, Select, Input, Button, Buttons, Button2 } from './style'
...
const ApplicationFormPage = (props) => {
  ...
  const creatNewApply = (event) => {
    event.preventDefault()

    axios.post(`${Url}/trips/${formulario.trip}/apply`, formulario)
      .then(res => {
        alert('Sucesso! Agora espere a aprovação.')
        limpa()
  ...
  return (
    <Pai>
      ...
      <Div onSubmit={creatNewApply}>
        <Select onChange={onChange}
          name={'trip'}
          required>
          <option value={''} disabled>Escolha o lugar</option>
          {allTrips}
        </Select>
